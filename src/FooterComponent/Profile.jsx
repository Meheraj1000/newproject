...
const steps = [
  ...
  },
  {
    ...
    desc: "আমরা আমাদের কৃষি উপকরণ কোম্পানিগুলির সাথে একত্রে আমাদের তালিকাভুক্ত কৃষকদের তত্ত্বাবধান করি...",
      ...
      <div className="px-4 mt-4 space-y-5">
        {steps?.map((step) => (
          ...
          >
            ...
            <div className="absolute top-0 right-0 bg-indigo-100 px-3 py-1 rounded-bl-xl text-indigo-700 text-sm font-semibold">
              ধাপ {step.id}
            </div>
          </Link>
        ))}
